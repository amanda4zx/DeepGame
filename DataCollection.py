...
class DataCollection:
    ...
    def addRunningTime(self, running_time):
        self.fileHandler.write("Running time: %s\n" % running_time)

    def addConfidence(self, confidence):
        self.fileHandler.write("Confidence: %s\n" % confidence)

    def addManipulationPercentage(self, mani_percentage):
        self.fileHandler.write("Manipulation percentage: %s\n" % mani_percentage)

    def addl2Distance(self, l2dist):
        self.fileHandler.write("L2 distance: %s\n" % l2dist)

    def addl1Distance(self, l1dist):
        self.fileHandler.write("L1 distance: %s\n" % l1dist)

    def addl0Distance(self, l0dist):
        self.fileHandler.write("L0 distance: %s\n" % l0dist)
