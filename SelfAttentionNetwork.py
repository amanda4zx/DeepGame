...
class SelfAttentionNetwork(object):
    ...
    def train(self):
        ...
        if self.data_set == 'mnist' :
            ...
            conv3 = self.AugmentedConv2D(64, (3, 3), activation='relu', dk = 8, dv = 8)(pool1)
